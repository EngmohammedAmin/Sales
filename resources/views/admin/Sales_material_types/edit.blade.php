            ...
            <div class="card">
                <div class="card-header" style="background:rgb(247, 247, 250);">
                    <h3 class="card-title card_title_center"
                        style="font-size: 25px;font-family:'Times New Roman', Times, serif"> تعديل بيانات فئة الفواتير:
                        {{ $data->name }} </h3>
                </div>
                <div class="card-body " style="overflow-x:auto;background:rgb(173, 238, 247)">
                    <form action="{{ route('admin.Sales_material_types.update') }}" method="post" autocomplete="off"
