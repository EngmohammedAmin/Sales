        ...
        <div class="col-12">
            <div class="card" style="overflow-x:auto;background:rgb(129, 144, 146)">
                <div class="card-header" style="background:rgb(247, 247, 250);">
                    <h3 class="card-title card_title_center"
                        style="font-size: 25px;font-family:'Times New Roman', Times, serif">إضافة فئة صنف جديد </h3>
                </div>
                <div class="card-body" style="overflow-x:auto;background:rgb(129, 144, 146)">
                    <form action="{{ route('item_card_cats.store') }}" method="post" autocomplete="off" style=""
            ...
            <div class="d-flex justify-content-center">
                <tr>
                    ...
                    <td> <a href="{{ route('item_card_cats.index') }}" class="btn btn-sm btn-danger"style="margin: 10px">
                            إلغاء
                        </a>
                    </td>
