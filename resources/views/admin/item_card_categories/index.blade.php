...
@section('contentheaderlink')
    <a href="{{ route('item_card_cats.index') }}"> فئات الأصناف </a>
@endsection
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title card_title_center"
                        style="font-size: 25px;font-family:'Times New Roman', Times, serif"> بيانات فئات الأصناف </h3>

                    <input type="hidden" id="token_item_cats_search" value="{{ csrf_token() }}">
                    <input type="hidden" id="ajax_item_cats_search_url"
                        value="{{ route('item_card_cats.ajax_item_card_cats_search') }}">

                    <div class="col-sm-6 col-md-4 col-xl-3">
                        {{--  @can('اضافة خزنة')  --}}
                        <a class=" btn btn-sm btn-success " href="{{ route('item_card_cats.create') }}">إضـــــــافة
                            فـــــئة
                        </a>
                        {{--  @endcan  --}}
                ...
                <div class="card-body " style="overflow-x:auto;">
                    ...
                    <div class="col-md-4" style="margin-bottom: 10px">
                        <input type="text"class="form-control" id="search_item_cats_by_text" placeholder="بحث بالاسم ">
                    </div>


                    <div id="ajax_item_cats_searchDiv">
                                        ...
                                        <tr>
                                            ...
                                            <td style=""class="control">
                                                <div style="display:flex;margin:5px;">
                                                    ...
                                                    <a href="{{ route('item_card_cats.edit', [$d->id]) }}"
                                                        class="btn btn-sm btn-success" style="margin-left: 5px"> تعديل
                                                    </a>

                                                    <form action="{{ route('item_card_cats.destroy', [$d->id]) }}"
                                                        method="post">
                                                        {{ method_field('delete') }}
                                                        @csrf
...
@section('script')
    ...
    <script src="{{ asset('assets/admin/js/item_cats.js') }}"></script>


    <!-- سكريبت حذف الفئة  -->
    <script>
        $(document).on('click', '.are_you_sure', function(e) {
            var res = confirm(" هل أنت متأكد من عملية الحذف قد يكون هناك  متعلقات بهذا المخزن ")
