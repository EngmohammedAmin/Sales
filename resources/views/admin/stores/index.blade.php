            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title card_title_center"
                        style="font-size: 25px;font-family:'Times New Roman', Times, serif"> بيانات المخازن </h3>

                    <input type="hidden" id="token_stores_search" value="{{ csrf_token() }}">
                    <input type="hidden" id="ajax_stores_search_url"
                        value="{{ route('admin.stores.ajax_stores_search') }}">

                    <div class="col-sm-6 col-md-4 col-xl-3">
                        {{--  @can('اضافة خزنة')  --}}
                        <a class=" btn btn-sm btn-success " href="{{ route('admin.stores.create') }}">اضافة
                            مخزن
                        </a>
                        {{--  @endcan  --}}
                ...
                <div class="card-body " style="overflow-x:auto;">
                    ...
                    <div class="col-md-4" style="margin-bottom: 10px">
                        <input type="text"class="form-control" id="search_stores_by_text" placeholder="بحث بالاسم ">
                    </div>


                    <div id="ajax_stores_searchDiv">
                                        ...
                                        <tr>
                                            ...
                                            <td style=""class="control">
                                                <div style="display:flex;margin:5px;">
                                                    ...
                                                    {{--  <a href="{{ route('admin.stores.details', [$d->id]) }}"
                                                        class="btn btn-sm btn-info" style="margin-left: 5px">
                                                        المزيد </a>  --}}

                                                    <form action="{{ route('admin.stores.delete', [$d->id]) }}"
                                                        method="POST">
                                                        @csrf
...
@section('script')
    ...
    <script src="{{ asset('assets/admin/js/stores.js') }}"></script>
