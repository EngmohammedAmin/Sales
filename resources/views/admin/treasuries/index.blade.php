            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title card_title_center"
                        style="font-size: 25px;font-family:'Times New Roman', Times, serif"> الخزانة </h3>
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        {{--  @can('اضافة خزنة')  --}}
                        <a class=" btn btn-sm btn-outline-primary " href="{{ route('admin.treasuries.create') }}">اضافة خزنة
                        </a>
                        {{--  @endcan  --}}
                ...
                <div class="card-body " style="overflow-x:auto;">
                    ...
                    <div class="col-md-4" style="margin-bottom: 10px">
                        <input type="text"class="form-control" id="search_by_text" placeholder="بحث بالاسم ">
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td style=""class="control">
                                                <div style="display:flex;margin:5px;">
                                                    <a href="treasuries/edit/{{ $d->id }}"
                                                        class="btn btn-sm btn-success" style="margin-left: 5px"> تعديل
                                                    </a>
                                                    <a href="{{ route('admin.treasuries.details', [$d->id]) }}"
                                                        class="btn btn-sm btn-info" style="margin-left: 5px">
                                                        المزيد </a>


                                                    <a href="{{ route('admin.treasuries.delete_treasuries', [$d->id]) }}"
...
@section('script')
    ...
    <script>
        $('#delete_treasur').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget)
            var treasur_id = button.data('treasur_id')
            var modal = $(this)
            modal.find('.modal-body #treasur_id').val(treasur_id);
        })
    </script>
    <!-- مودل حذف الخزانة  -->
    <script>
        $(document).on('click', '.are_you_sure', function(e) {
            var res = confirm(" هل أنت متأكد من عملية الحذف قد يكون هناك خزنات فرعية متعلقة بهذه الخزانة ")
