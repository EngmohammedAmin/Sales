            ...
            @foreach ($data as $d)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <div class="bg-warning"style="  box-sizing: border-box; "> وحدات تجزئة </div>
                        @endif
                    </td>
                    <td> {{ $d->com_code }}</td>
                    <td> {{ $d->added_by }}</td>
                    ...
                    <td style=""class="control">
                        <div style="display:flex;margin:5px;">
                            <a href="{{ route('admin.inv_uoms.edit', [$d->id]) }}" class="btn btn-sm btn-success"
                            ...
                            <form action="{{ route('admin.inv_uoms.delete', [$d->id]) }}" method="POST">
                                @csrf
...
<div class="col-md-12" id="ajax_inv_uoms_pagination_in_search">
    {{ $data->links() }}
</div>
