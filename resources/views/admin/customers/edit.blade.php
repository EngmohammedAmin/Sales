            ...
            <div class="card" style="overflow-x:auto;background:rgb(6, 70, 78)">
                <div class="card-header" style="background:rgb(247, 247, 250);">
                    <h3 class="card-title card_title_center"
                        style="font-size: 25px;font-family:'Times New Roman', Times, serif">تعديل بيانات العميل :
                        ( {{ $data->name }}) </h3>
                </div>
                <div class="card-body" style="overflow-x:auto;background:rgb(15, 86, 94);color:white">
                    <form action="{{ route('admin.customers.update', [$data->id]) }}" method="post" autocomplete="off"
                        ...
                        @if (@isset($data) && !@empty($data))
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="name" class="control-label">إسم العميل </label>
