...
@section('contentheader')
    الحســـــابات / العملاء
@endsection

{{--  ------- ارسال رابط صفحة المحتوى ----  --}}
@section('contentheaderlink')
    <a href="{{ route('admin.customers.index') }}"> بيانات العملاء </a>
@endsection
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title card_title_center"
                        style="font-size: 25px;font-family:'Times New Roman', Times, serif"> بيانات العملاء </h3>

                    <input type="hidden" id="token_customers_search" value="{{ csrf_token() }}">
                    <input type="hidden" id="ajax_customers_search_url"
                        value="{{ route('admin.customers.ajax_customers_search') }}">

                    <div class="col-sm-6 col-md-4 col-xl-3">
                        {{--  @can('اضافة خزنة')  --}}
                        <a class=" btn btn-sm btn-outline-primary " href="{{ route('admin.customers.create') }}">اضافة عميل
                        </a>
                        {{--  @endcan  --}}
                ...
                <div class="card-body " style="overflow-x:auto;">
                    ...
                    <div class="row">
                        <div class="col-md-4" style="margin-bottom: 10px">
                            ...
                            <input type="radio" name="search_radio" value="searchby_customer_code"> رقم العميل

                            <input autofocus type="text"class="form-control" id="search_customers_text"
                                placeholder="بحث بالاسم او رقم الحساب أو رقم العميل  ">
                        </div>

                    </div>
                    <div id="ajax_customers_searchDiv">
                                        ...
                                        <tr>
                                            ...
                                            <td style=""class="control">
                                                <div style="">
                                                    ...
                                                    <a href="{{ route('admin.customers.edit', [$d->id]) }}"
                                                        class="btn btn-sm btn-success" style="margin-left: 5px"> تعديل
                                                    </a>

                                                    <a href="{{ route('admin.customers.destroy', [$d->id]) }}"
